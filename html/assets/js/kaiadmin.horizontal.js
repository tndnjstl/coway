...
var showSidebar = false,
  showSidebarButton = $(".btn-show-sidebar"),
  closeSidebarButton = $(".btn-close-sidebar"),
  overlayHTML = "<div class='overlay_sidebar_show'></div>";

function toggleSidebar() {
  if (showSidebar) {
    $(".wrapper").removeClass("sidebar_show");
    $(".overlay_sidebar_show").remove();
    showSidebarButton.removeClass("toggled");
    showSidebar = false;
  } else {
    $(".wrapper").addClass("sidebar_show");
    $(".wrapper").append(overlayHTML);
    showSidebarButton.addClass("toggled");
    showSidebar = true;
  }
  $(window).resize();
}
